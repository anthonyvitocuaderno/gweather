...
class RegisterUserUseCase
    ...
    ) : BaseUseCase<Unit, RegisterUserUseCase.Params> {
        override fun run(params: Params): Flow<Either<Failure, Unit>> {
            ...
            return if (email.isLeft) {
                ...
                flow { emit(authRepository.register(User(email.get()), password.get())) }
            }
        }
